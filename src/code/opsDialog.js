...
Wasabee.opsDialog = class {
    constructor(operationList) {
        ...
        this._dialog = window.dialog({
            ...
            closeCallback: (popoverName) => {
                var paneIndex = opsDialog._dialogs.indexOf(self);
                if (-1 !== paneIndex) {
                    opsDialog._dialogs.splice(paneIndex, 1);
                }
            }
        });
    }
    setupSpinner() {
        ...
        this._operationList.forEach((op) =>
    ...
    updateContentPane(operation, opListSize) {
        ...
        $(opColor).change(() => Operation.create(operation).colorSelected($(opColor).val(), input.value, commentInput.value));
        ...
        */
        ...
        clearOpButton.addEventListener("click", (arg) => {
        ...
        deleteButton.addEventListener("click", (arg) => {
    ...
    static update(operationList, show = true, close = false) {
        var parameters = opsDialog._dialogs;
