export const WTooltip = L.Class.extend({
  ...
  updateContent: function(labelText) {
    ...
    if (labelText.subtext.length === 0 && !this._singleLineLabel) {
      ...
      L.DomUtil.removeClass(this._container, "wasabee-tooltip-single");
      this._singleLineLabel = false;
    }

    this._container.innerHTML =
      (labelText.subtext.length > 0
        ? '<span class="wasabee-tooltip-subtext">' +
          labelText.subtext +
          "</span>" +
          "<br />"
        : "") +
...
export const WDialog = L.Handler.extend({
  // includes: L.Mixin.Events, // this.fire
...
export const Toolbar = L.Class.extend({
  ...
  _handlerActivated: function(e) {
    ...
    L.DomUtil.addClass(
      ...
      "wasabee-toolbar-button-enabled"
    );
  ...
  _showActionsToolbar: function() {
    ...
    if (buttonIndex === 0) {
      L.DomUtil.addClass(this._toolbarContainer, "wasabee-toolbar-notop");
      L.DomUtil.addClass(this._actionsContainer, "wasabee-actions-top");
    }

    if (buttonIndex === lastButtonIndex) {
      L.DomUtil.addClass(this._toolbarContainer, "wasabee-toolbar-nobottom");
      L.DomUtil.addClass(this._actionsContainer, "wasabee-actions-bottom");
    }
  ...
  _hideActionsToolbar: function() {
    ...
    L.DomUtil.removeClass(this._toolbarContainer, "wasabee-toolbar-notop");
    L.DomUtil.removeClass(this._toolbarContainer, "wasabee-toolbar-nobottom");
    L.DomUtil.removeClass(this._actionsContainer, "wasabee-actions-top");
    L.DomUtil.removeClass(this._actionsContainer, "wasabee-actions-bottom");
  }
});
