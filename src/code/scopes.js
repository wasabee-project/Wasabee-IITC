...
!(function(scope) {
    scope.alertTypes = [
        ...
        },
        {
            ...
            label: "link",
            color: "#5994FF",
            markerIcon: scope.static.images.marker_alert_link
        },
        {
            name: Wasabee.Constants.MARKER_TYPE_MEETAGENT,
            label: "go to",
            color: "#EDA032",
            markerIcon: scope.static.images.marker_alert_meetagent
        },
        {
            name: Wasabee.Constants.MARKER_TYPE_OTHER,
            label: "other",
            color: "#3679B4",
            markerIcon: scope.static.images.marker_alert_other
        },
        {
            name: Wasabee.Constants.MARKER_TYPE_RECHARGE,
            label: "recharge",
            color: "#53AD53",
            markerIcon: scope.static.images.marker_alert_recharge
        },
        {
            name: Wasabee.Constants.MARKER_TYPE_UPGRADE,
            label: "upgrade",
            color: "#448800",
            markerIcon: scope.static.images.marker_alert_upgrade
        }
    ];
})(Wasabee || (Wasabee = {}));
