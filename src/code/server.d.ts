...
declare function genericGet(url: string, formData: FormData | string, contentType?: string): Promise<IServerUpdate>;
declare function genericPost(url: string, formData: FormData | string, contentType?: string): Promise<IServerUpdate>;
declare function genericPut(url: string, formData: FormData | string, contentType?: string): Promise<IServerUpdate>;
declare function genericDelete(url: string, formData: FormData | string, contentType?: string): Promise<IServerUpdate>;
